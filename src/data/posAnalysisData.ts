...
export const posAnalysisData: POSAnalysisMap = {
  ...
  university: {
    salesTrend: {
      ...
      totalChange: 18.5,
      items: [
        { category: '에너지드링크', amount: 520, change: 95, barPercent: 100 },
        { category: '커피/음료', amount: 380, change: 35, barPercent: 73 },
        { category: '라면/즉석식품', amount: 350, change: 25, barPercent: 67 },
        { category: '과자/초콜릿', amount: 250, change: 40, barPercent: 48 },
        { category: '도시락/삼각김밥', amount: 180, change: 15, barPercent: 35 },
      ],
    },
    salesForecast: {
      weekTotal: '1,850만원',
    ...
    orderRecommend: {
      ...
      items: [
        { product: '레드불 250ml', currentStock: 8, recommended: 60, reason: '기말고사 D-3, 에너지드링크 +95%', urgency: 'high' },
  ...
  entertainment: {
    ...
    salesForecast: {
      ...
      days: [
        { day: '월', predicted: 180, barPercent: 47 },
        { day: '화', predicted: 175, barPercent: 46, isToday: true },
        { day: '수', predicted: 200, barPercent: 53 },
        { day: '목', predicted: 250, barPercent: 66 },
        { day: '금', predicted: 340, barPercent: 89, isPeak: true },
        { day: '토', predicted: 380, barPercent: 100, isPeak: true },
        { day: '일', predicted: 375, barPercent: 99 },
      ],
    },
    orderRecommend: {
      totalItems: 18,
