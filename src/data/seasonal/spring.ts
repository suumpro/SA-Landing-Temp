...
export const springScenarios: SeasonScenarios = {
  ...
  office: [
    day(0, '미세먼지 나쁨 - 실내 근무 대응', {
      ...
      events: [
        { icon: '😷', title: '미세먼지 주의보', detail: 'PM2.5 농도 81μg/m³ (나쁨)', impact: '마스크 매출 +180%, 외출 간식 -40%' },
  ...
  university: [
    ...
    day(4, '개강 파티 - 주류·안주 폭발', {
      ...
      events: [
        { icon: '🍻', title: '개강 파티', detail: '금요일 밤 신입생 환영회 (저녁 7시~)', impact: '맥주 +400%, 소주 +350%, 안주 +300%' },
  ...
  entertainment: [
    ...
    day(4, '불금 + 봄밤 - 주류·안주 피크', {
      ...
      events: [
        { icon: '🍻', title: '불금 피크', detail: '홍대 거리 인파 폭증 (저녁 7시~)', impact: '맥주 +450%, 소주 +400%, 안주 +350%' },
    ...
    day(5, '벚꽃 거리 + 플리마켓 - 종일 테이크아웃', {
      ...
      events: [
        hongdaeFleaMarket,
        { icon: '🌸', title: '벚꽃 거리 축제', detail: '홍대 거리 벚꽃 구경 인파 (종일)', impact: '음료 +350%, 간식 +300%' },
      ],
      checklist: [
